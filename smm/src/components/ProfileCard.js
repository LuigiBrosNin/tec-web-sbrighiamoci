            ...
            <div className="card">
                <div className="row no-gutters">
                    <div className="col-12 justify-content-center align-items-center">
                        <img src={this.props.profile.propic == null ? "https://site222326.tw.cs.unibo.it/images/user-default.svg" : this.props.profile.propic } className="card-img profile_img" alt="Profile Picture" />
                    </div>
